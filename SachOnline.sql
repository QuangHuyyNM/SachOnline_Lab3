...
ALTER TABLE SACH ADD CONSTRAINT FK_S_CD FOREIGN KEY (MaCD) REFERENCES CHUDE(MaCD)
ALTER TABLE SACH ADD CONSTRAINT FK_Sach_NXB FOREIGN KEY (MaNXB) REFERENCES NHAXUATBAN(MaNXB)
ALTER TABLE VIETSACH ADD CONSTRAINT FK_VS_TG FOREIGN KEY (MaTG) REFERENCES TACGIA(MaTG)
ALTER TABLE VIETSACH ADD CONSTRAINT FK_VS_S FOREIGN KEY (MaSach) REFERENCES SACH(MaSach)
...
ALTER TABLE CHITIETDATHANG ADD CONSTRAINT FK_CTDH_S FOREIGN KEY (MaSach) REFERENCES SACH(MaSach)
GO

/****** Object:  Table [dbo].[CHUDE]    Script Date: 10/19/2020 13:14:22 ******/
...
/****** Object:  Table [dbo].[NHAXUATBAN]    Script Date: 10/19/2020 13:14:22 ******/
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (1, N'Giáo trình Tin học cơ bản', 26000, N'Nội dung của cuốn: Tin Học Cơ Bản Windows XP gồm có 7 chương:
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (2, N'Giáo trình Tin học văn phòng', 12000, N'Cuốn sách này gồm 3 phần sau:
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (3, N'Lập Trình Cơ Sở Dữ Liệu Với Visual Basic 2005 Và ADO.NET 2.0', 11500, N'Cuốn sách "Lập Trình Cơ Sở Dữ Liệu Với Visual Basic 2005 Và ADO.NET 2.0" này giới thiệu các nội dung sau:
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (4, N'Visual Basic 2005 Tập 3, Quyển 2: Lập Trình Web', 20000, N'"Visual Basic 2005 Tập 3, Quyển 2: Lập Trình Web Với Cơ Sở Dữ Liệu" sẽ cung cấp kỹ thuật và hướng dẫn bạn:
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (5, N'Giáo trình Tin học quản lý 1', 21000, N'Mạng Máy Tính Và Hệ Thống Bảo Mật gồm 7 chương:
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (13, N'Điều Chỉnh Một Số Chính Sách Kinh Tế Ở Trung Quốc (Giai Đoạn 1992 - 2010)', 21000, N'Cuốn sách này tập trung vào một số nội dung chính sau đây:
...
Tập thể tác giả tham gia công trình này đều là những người chuyên nghiên cứu về Trung Quốc, hy vọng sẽ đem lại cho các bạn nhiều thông tin bổ ích.', N'KT0001.jpg', 1, 7, '04/02/2021', 19)
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (14, N'30 phút mỗi ngày để luyện kỹ năng viết câu tiếng Anh', 85000, N'30 phút mỗi ngày để luyện kỹ năng viết câu tiếng Anh là một cuốn sách bài tập dành cho những học sinh/sinh viên nghiêm túc quan tâm đến tầm quan trọng của việc nâng cao những yếu tố kỹ thuật cho kỹ năng viết của mình. Rèn luyện để viết cho tốt chẳng khác gì tự trang bị cho mình một sức mạnh cần thiết để thành công - khi đi học cũng như khi ra ngoài xã hội. Trui rèn được một trình độ viết “cứng” không hề là chuyện bỗng nhiên trời cho mà có được; đó phải là kết quả của một quá trình phấn đấu bền bỉ và rèn luyện chăm chỉ.
...
Sử dụng cuốn 30 phút mỗi ngày để luyện kỹ năng viết câu tiếng Anh này sẽ giúp học sinh/sinh viên viết “có nghề” và tự tin hơn".', N'TiengAnh01.jpg', 2, 1, '02/10/2016', 7)
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (15, N'Tin Học Ứng Dụng: Thành Thạo Oracle 9i - Quản Trị Cơ Sở Dữ Liệu (Tập 1) ', 21000, N'Mục đích của bộ sách này giúp bạn trở nên thành thạo cơ sở dữ liệu (CSDL) Oracle9i, đề cập đến tất cả những kiến thức cần thiết từ mô hình dữ liệu, quản trị CSDL, sao lưu phục hồi, mạng và xử lý sự cố cũng như hiệu chỉnh hiệu suất thực thi..., với sự kết hợp lý thuyết và thực hành về điều mà Nhà quản trị CSDL Oracle9i cần biết để sử dụng CSDL Oracle9i một cách hiệu quả từ chính bộ sách này.
Bộ sách được chia làm 2 tập, tập 1 đề cập các kiến thức cơ bản về CSDL, mô hình dữ liệu. Bạn sẽ được biết về hệ quản trị CSDL Oracle9i, tạo CSDL, kết nối và quản lý người dùng. Tập 2 hướng dẫn bạn cách nạp, sao lưu và phục hồi dữ liệu, quản lý hoạt động CSDL Oracle9i, thực hiện hiệu chỉnh hiệu suất thực thi và xử lý sự cố cho CSDL.
Xin trân trọng giới thiệu Tập 1 cùng các bạn. ', N'TH001.jpg', 1, 2, '04/12/2019', 28)
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (16, N'Mạng Máy Tính Và Hệ Thống Bảo Mật ', 23000, N'Mạng Máy Tính Và Hệ Thống Bảo Mật gồm 7 chương:
Chương I: Tổng quan về công nghệ mạng máy tính và mạng cục bộ.
Chương II: Các thiết bị mạng thông dụng và các chuẩn kết nối vật lý.
Chương III: TCP/IP và mạng Internet.
Chương IV: Hệ điều hành mạng đặc điểm của hệ điều hành mạng.
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (17, N'Thủ Thuật Lập Trình Visual Basic 6 ', 18000, N'Mục Lục:
Chương 1: Multimedia.
Chương 2: String.
Chương 3: Form.
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (18, N'Lập Trình Mạng Trên Windows (Ấn bản dành cho sinh viên) ', 16800, N'Chào mừng đến với "Lập Trình Mạng Trên Windows (Ấn bản dành cho sinh viên)". Quyển sách này sẽ hướng dẫn bạn sử dụng một cách hiệu quả bao gồm một số lượng lớn và đa dạng các hàm mạng sẵn có trong Windows 95, Windows 98, Windows NT 4, Windows CE, và Windows 2000/XP/. NET. Sách được chủ định viết dành cho những lập trình viên từ trung cấp đến cao cấp, tuy nhiên những lập trình viên mới bắt đầu tìm hiểu lập trình mạng cũng sẽ nhận thấy đây là một quyển sách không thể thiếu cho các bước xây dựng ứng dụng mạng sau này.
', N'TH001.jpg', 5, 5, '03/29/2020', 8)
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (19, N'Căn Bản Về Photoshop CS Tinh Chỉnh Và Xử Lý Màu ', 25000, N'"Căn Bản Về Photoshop CS Tinh Chỉnh Và Xử Lý Màu" gồm 12 chương:
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (20, N' Hướng Dẫn Sử Dụng Norton AntiVirus 2004 (Hướng dẫn bằng hình)  
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (21, N'Tin Học Văn Phòng - Microsoft Word 2000 (Tái Bản Lần Thứ Nhất) ', 15600, N' ', N'TH002.jpg', 2, 8, '02/23/2020', 6)
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (22, N'Adobe Photoshop 6.0 và ImageReady 3.0 ', 21000, N'Cuốn sách Adobe Photoshop 6.0 và ImageReady 3.0 này sẽ giúp bạn tìm hiểu những tính năng tuyệt vời của phiên bản 6.0, nó cũng là con đường ngắn nhất cho những người mới sử dụng Photoshop lần đầu. Với bạn đọc đã sử dụng cuốn sách "Adobe Photoshop 5.5 và ImageReady 2.0" do MK.PUB biên soạn trước đây, cuốn sách này là một cách cập nhật nhanh chóng nhất.
...
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (23, N'Hướng Dẫn Tự Học Photoshop CS (Photoshop 8.0) ', 25000, N' ', N'TH003.jpg', 8, 4, '07/29/2019', 9)
INSERT [dbo].[SACH] ([Masach], [Tensach], [GiaBan], [Mota], [AnhBia], [MaCD], [MaNXB], [Ngaycapnhat], [SoLuongBan]) VALUES (24, N'Tin Học Văn Phòng - Microsoft Excel 2000 (Tái Bản Lần Thứ Nhất)', 16800, N'Cuốn sách này gồm những nội dung chính sau:
Chương 1: Giới thiệu
...
/****** Object:  Table [dbo].[TACGIA]    Script Date: 10/19/2020 13:14:22 ******/
SET IDENTITY_INSERT [dbo].[TACGIA] ON
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (1, N'Phạm Công Anh', N'197 Trần Hưng Đạo', N'98877668')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (2, N'Nguyễn Thế Giang', N'179 Chánh hưng - F.4 - Q.8 Tp.HCM', N'19001611')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (3, N'Lê Việt Nhân', N'45 Lý Thái Tổ-F2.Q.3 Tp.HCM', N'19001570')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (4, N'Hồng Phúc', N'', N'')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (5, N'Ks.Phạm Quang Huy', N'', N'')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (6, N'Nguyễn Bá Tiến', N'', N'')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (7, N'Phạm Hữu Khang', N'', N'')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (8, N'Nguyễn Minh Đức', NULL, NULL)
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (9, N'Trần Văn Lăng', NULL, NULL)
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (10, N'Quách Tuấn Ngọc', NULL, NULL)
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (11, N'Nguyễn Xuân Huy', NULL, NULL)
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (12, N'Đoàn Khắc Độ', NULL, NULL)
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (13, N'Nguyễn Tấn Tín', N'179 Chánh Hưng F.4 Q.8 Tp.HCM', N'8504122')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (14, N'Phạm Phan Trung', N'124 Bắc Hải P.6 Q.TB', N'0918121188')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (15, N'TS. Nguyễn Phương Liên', N'', N'')
INSERT [dbo].[TACGIA] ([MaTG], [TenTG], [Diachi], [Dienthoai]) VALUES (16, N'BS. Vũ Thị Uyên Thanh', N'', N'')
SET IDENTITY_INSERT [dbo].[TACGIA] OFF


/****** Object:  Table [dbo].[THAMGIA]    Script Date: 10/19/2020 13:14:22 ******/
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (1, 1, N'Tác giả', N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (1, 3, N'Đồng tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (1, 4, N'Hiệu đính',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (1, 10, N'Chủ biên',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (2, 3, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (2, 14, N'Đồng tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (3, 5, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (3, 6, N'Hiệu đính',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (4, 5, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (5, 6, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (5, 12, N'Chủ biên',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (6, 14, N'Sưu tầm và biên soạn',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (7, 8, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (8, 7, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (10, 11, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (11, 6, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (12, 13, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (13, 16, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (14, 7, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (15, 12, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (16, 14, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (17, 14, N'Chủ biên',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (17, 15, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (18, 15, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (19, 5, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (20, 8, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (21, 13, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (22, 10, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (23, 11, N'Tác giả',N'')
INSERT [dbo].[VIETSACH] ([Masach], [MaTG], [Vaitro], [ViTri]) VALUES (24, 2, N'Tác giả',N'')


/****** Object:  Table [dbo].[KHACHHANG]    Script Date: 10/19/2020 13:14:22 ******/
SET IDENTITY_INSERT [dbo].[KHACHHANG] ON
INSERT [dbo].[KHACHHANG] ([MaKH], [Hoten], [Diachi], [Dienthoai], [TaiKhoan], [Matkhau], [Ngaysinh], [Email]) VALUES (1, N'Võ Quốc Lương', N'Phú Hòa', N'0988936592', N'luongvq', N'12345', '02/10/1982', N'luongvq@tdmu.edu.vn')
...
/****** Object:  Table [dbo].[DONDATHANG]    Script Date: 10/19/2020 13:14:22 ******/
...
/****** Object:  Table [dbo].[CTDATHANG]    Script Date: 10/19/2020 13:14:22 ******/
INSERT [dbo].[CHITIETDATHANG] ([MaDonHang], [Masach], [SoLuong], [DonGia]) VALUES (1, 19, 1, 25000)
INSERT [dbo].[CHITIETDATHANG] ([MaDonHang], [Masach], [SoLuong], [DonGia]) VALUES (1, 23, 2, 25000)
INSERT [dbo].[CHITIETDATHANG] ([MaDonHang], [Masach], [SoLuong], [DonGia]) VALUES (2, 1, 1, 26000)
INSERT [dbo].[CHITIETDATHANG] ([MaDonHang], [Masach], [SoLuong], [DonGia]) VALUES (2, 17, 3, 18000)
...
/****** Object:  Table [dbo].[ADMIN]    Script Date: 10/19/2020 13:14:22 ******/
